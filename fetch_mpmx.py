...
print("=" * 60)
print(f"MPMX.JK DATA FETCH — {datetime.utcnow().isoformat()}Z")
print("=" * 60)
...
try:
    ...
    block_a = {
        ...
        "weekly_bars_2y":   hist_2y_weekly[["Open","High","Low","Close","Volume"]].to_dict("index"),
...
print("\n### BLOCK E: Technical Indicators ###")
try:
    if not block_a_ok or not block_a.get("daily_bars_1y"):
