...
analyst_data = {
    ...
    "upside_to_mean_pct":     round((mean_pt - current_price) / current_price * 100, 2)
                              if mean_pt and current_price and current_price > 0 else None,
...
if not hist_1y.empty:
    ...
    print(json.dumps({"error": "No daily bars available for technical indicators."}))
